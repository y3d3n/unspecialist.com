<footer class="container flex">
    <p class="copy">&copy; <?php echo date("Y"); ?> unspecialist.com | Yeden Sherpa</p>
    <div class="socials flex">
        <a href="https://www.linkedin.com/in/yedensherpa" target="_blank">
        ...
        <a href="https://x.com/yedensherpa" target="_blank">
